...
# Use only 2025 trailing 12 months for contemporary stable baseline
...
print(f"\nOverall Mean: R² = {mean_r2:.4f}, RMSE = {mean_rmse:.2f}, MAE = {mean_mae:.2f}")

# Train on full national dataset to extract feature importances
print("\nExtracting feature importances from full model...")
...
for i, feature in enumerate(features):
    importance_results.append({
        ...
        "Importance": rf_full.feature_importances_[i]
    })
